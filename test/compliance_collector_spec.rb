  ...
  def previous_summary
    {
      ...
      'targets' => [
        target.merge(
          ...
          'passed_versions' => [{ 'core' => '3.2.2', 'sxls' => { 'tlc' => '1.2.1' } }],
  ...
  def report(run_id, attempt, core, status, generated_at)
    {
      ...
      'matrix' => { 'core' => core, 'sxls' => { 'tlc' => '1.2.1' } },
...
describe RSMP::Website::Compliance::Summary do
      ...
      'demo' => [
        {
          ...
          'total_cells' => 2,
          'cells' => [
            { 'core' => '3.2.2', 'sxls' => { 'tlc' => '1.2.1' }, 'status' => 'passed' },
            { 'core' => '3.3.0', 'sxls' => { 'tlc' => '1.2.1' }, 'status' => 'passed' }
          ]
        }
      ]
    }
    ...
    runs = {
      'demo' => [
        ComplianceCollectorSpec.run_summary(2, 'failed', '2026-06-17T00:00:01Z', 1).merge(
          'cells' => [{ 'core' => '3.2.2', 'sxls' => { 'tlc' => '1.2.1' }, 'status' => 'failed' }]
        )
      ]
    }
...
describe RSMP::Website::Compliance::Collector do
